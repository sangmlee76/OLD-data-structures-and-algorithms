...
------------------------------------------------------------------------------------------------ */
// TODO: Wasn't able to complete this, will need to come back to it

// const createList = (availableItems) => {
//   let myCart = [];
//   availableItems.forEach((item, idx) => {
//     if (item[1] === true);
//     fillMyCart(myCart, item)
//   }  
//   return myCart;
// };

// function fillMyCart(cart, item){
//   cart.push(item);
// }
...
const fizzbuzz = (arr) => {
  arr.forEach(generateOutput);
};

function generateOutput(val){ 
  if (val % 3 === 0 && val % 5 === 0){
    outputArray.append("Fizz Buzz");
  } else if (val % 3 === 0){
    outputArray.append("Fizz");
  } else if (val % 5 === 0) {
    outputArray.append("Buzz");
  } else (outputArray.append(val))
  return outputArray;
} 
