...
const sortBackwards = (arr) => arr.sort(function(a,b) {
    return b-a;
});

OR (201 style; also note that below will execute faster because it is declared upfront so JS hoists it to the top)
